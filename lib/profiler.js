...
var profilerCode = [
    ...
    "sjsp__state = { time: 0, line: 0, col: 0, name: '' };",
...
function profiler(interval){
    profilerCode[profilerCode.length-1].replace(/INTERVAL/, interval);
    return profilerCode.join('');
}
